      ...
      <div className="w-5/6 mx-auto py-10 ">
        ...
        <div className="flex flex-col md:flex-row justify-start items-start">
          <div className=" w-full md:w-2/3">
            ...
            >
              <Form className="w-full flex flex-col sm:flex-row justify-between mx-auto items-start sm:items-center flex-wrap">
                {contactData.map((input) => (
                  ...
                  >
                    ...
                    <Field
                      ...
                      name={input.name}
                    />
                    <span className="text-red-600 text-xs font-semibold block">
